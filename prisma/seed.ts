    ...
    if (!existingCourse) {
      await prisma.course.create({
        data: {
          ...
          description: 'مادة شاملة لتعلم أساسيات اللغة العربية من الصفر. تشمل المادة قواعد النحو والصرف، المفردات الأساسية، والمحادثة اليومية.',
      ...
      await prisma.course.create({
        data: {
          ...
          description: 'مادة متقدمة في قواعد النحو العربي. تغطي المادة جميع قواعد النحو من المبتدأ والخبر إلى الإعراب والبناء.',
      ...
      await prisma.course.create({
        data: {
          ...
          description: 'تعلم المحادثة باللغة العربية الفصحى والعامية. مادة عملية تركز على مهارات التحدث والاستماع.',
