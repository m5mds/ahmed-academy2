...
- **Language**: TypeScript
- **State Management**: React Hooks & Shared Mock Store
- **API**: Zoom Server-to-Server OAuth for live sessions
...
Open [http://localhost:3000](http://localhost:3000) (or the port specified in your console) to see the result.
